...
$string['emailisusername'] = 'Your email address will be used as your username.';
...
$string['errorwithform'] = 'Please correct the highlighted fields before continuing.';
...
$string['mfa_enrollment_available_factors'] = 'Available authentication methods';
...
$string['mfa_enrollment_grace_period'] = 'Grace period';
$string['mfa_enrollment_grace_text'] = 'You can skip setup until {$a}.';
$string['mfa_enrollment_heading'] = 'Set up multi-factor authentication';
$string['mfa_enrollment_no_factors'] = 'No MFA factors are available. Contact your site administrator.';
$string['mfa_enrollment_select_method'] = 'Choose a method to set up multi-factor authentication.';
$string['mfa_enrollment_setup'] = 'Set up';
$string['mfa_enrollment_skip'] = 'Skip for now';
